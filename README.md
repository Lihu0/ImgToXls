Takes an image and converts its pixels into an Excel sheet. Each pixel's red, green, and blue values are displayed vertically within the same column, like this:
